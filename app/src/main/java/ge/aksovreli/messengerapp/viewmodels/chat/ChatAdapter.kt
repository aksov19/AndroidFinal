...
class ChatAdapter(private val chatItems: ArrayList<ChatItem>, private val signedInUid: String) : RecyclerView.Adapter<ChatAdapter.ChatViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ChatViewHolder, position: Int) {
        holder.bindItem(chatItems[position], signedInUid)
    }
    ...
    class ChatViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindItem(item: ChatItem, signedInUid: String) {
